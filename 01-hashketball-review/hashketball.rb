...
# instructors = [
#   {name: 'Graham', hometown: 'Oak Park, Illinois', mood: 'excited'},
#   {name: 'Mike', hometown: 'Lisle, Illinois'},
#   {name: 'Humzah', hometwon: 'Edmond, Oklahoma'},
#   {name: 'Josh', hometown: 'Houston, Texas'}
# ]

# def get_names(instructors)
#   # instructors_names = []
#   # instructors.each do |instructor_hash|
#   #   instructors_names << instructor_hash[:name]
#   # end
#   # instructors_names
